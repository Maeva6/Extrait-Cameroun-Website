...
export default function HistoriqueReapprovisionnementLab(){
    ...
    const filteredUpdates = updates.filter((u) =>
        u.nomIngredient?.toLowerCase().includes(searchTerm.toLowerCase())
    );
        ...
        useEffect(() => {
            setUpdates([
              {
                Id: '#REP-001',
                nomIngredient: 'Huile essentielle de vanille',
                quantite: '2 L',
                dateReapprovisionnement: '2025-05-01',
                fournisseur: 'Laboratoire Botanika',
              },
              {
                Id: '#REP-002',
                nomIngredient: 'Résine d’encens',
                quantite: '5 kg',
                dateReapprovisionnement: '2025-05-05',
                fournisseur: 'Pure Encens SARL',
              },
              {
                Id: '#REP-003',
                nomIngredient: 'Absolue de jasmin',
                quantite: '500 mL',
                dateReapprovisionnement: '2025-05-10',
                fournisseur: 'Exotic Essence',
              },
              {
                Id: '#REP-004',
                nomIngredient: 'Huile essentielle de menthe',
                quantite: '1.5 L',
                dateReapprovisionnement: '2025-05-12',
                fournisseur: 'Aromatik Afrique',
              },
              {
                Id: '#REP-005',
                nomIngredient: 'Bois de santal en poudre',
                quantite: '3 kg',
                dateReapprovisionnement: '2025-05-15',
                fournisseur: 'Laboratoire Botanika',
              },
              {
                Id: '#REP-006',
                nomIngredient: 'Hydrolat de rose',
                quantite: '4 L',
                dateReapprovisionnement: '2025-05-20',
                fournisseur: 'Brumes & Cie',
              },
            ]);
          }, []);
    ...
    return (
        ...
        <div className="flex items-center justify-between border-b border-yellow-400 pb-2 mb-6">
             ...
             <div className="bg-white shadow p-4 rounded">
                <h2 className="bg-[#D4AF37] text-black font-semibold px-2 py-1 rounded-t w-full">Historique des reapprovisionnement</h2>
                    ...
                    <table className="w-full table-auto mt-2">
                        <thead className="bg-black text-white">
                            <tr>
                                ...
                                <th className="p-3 text-left">date Reapprovisionnement</th>
                        ...
                        <tbody>
                            {filteredUpdates.map((u, index) => (
                                <tr key={index} className="border-b hover:bg-gray-50">
                                    ...
                                    <td className="p-3">{u.dateReapprovisionnement}</td>
