...
export default function IngredientLaboratoire(){
    ...
    const filteredUpdates = updates.filter((u) =>
        ...
        const exportToCSV = () => {
            ...
            const headers = ['ID', 'Nom du produit', 'Catégorie', 'prix', 'Quantité'];
    ...
    return (
        ...
        <div className="flex items-center justify-between border-b border-yellow-400 pb-2 mb-6">
             ...
             <div className="bg-white shadow p-4 rounded">
                <h2 className="bg-[#D4AF37] text-black font-semibold px-2 py-1 rounded-t w-full">Liste des Ingredients</h2>
                <div className="overflow-x-auto">
                    <table className="w-full table-auto mt-2">
                        <thead className="bg-black text-white">
                            <tr>
                                <th className="p-3 text-left">ID</th>
                                <th className="p-3 text-left">Nom de l'ingredient</th>
                        ...
                        <tbody>
                            {filteredUpdates.map((u, index) => (
                                <tr key={index} className="border-b hover:bg-gray-50">
                                    ...
                                    />
                                    <td className="p-3">{u.origine}</td>
                                    <td className="p-3">{u.prix}</td>
            ...
            <ConfirmDialog
                ...
                message="Êtes-vous sûr de vouloir supprimer cet ingredient ?"
            />
        </div>
    );
