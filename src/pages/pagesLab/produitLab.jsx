...
export default function ProduitLab(){
    ...
    const filteredUpdates = updates.filter((u) =>
        ...
        useEffect(() => {
            setUpdates([
              {
                Id: '#PDR-001',
                nomProduit: 'Eau de parfum Nuit Étoilée',
                categorie: 'Parfum',
                prix: '1500 FCFA',
                quantite: '10',
              },
              {
                Id: '#PDR-002',
                nomProduit: 'Encens Royal Bois d’Oud',
                categorie: 'Encens',
                prix: '800 FCFA',
                quantite: '5',
              },
              {
                Id: '#PDR-003',
                nomProduit: 'Brume Vanille Gourmande',
                categorie: 'Brume',
                prix: '1200 FCFA',
                quantite: '15',
              },
              {
                Id: '#PDR-004',
                nomProduit: 'Bougie Fleur d’Oranger',
                categorie: 'Bougie',
                prix: '1800 FCFA',
                quantite: '7',
              },
              ...
              {
                Id: '#PDR-006',
                nomProduit: 'Savon noir oriental',
