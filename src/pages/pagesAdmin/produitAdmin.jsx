...
import NotificationsAdmin from '../../components/notificationAdmin';
...
export default function ProduitAdmin() {
    ...
    return (
        <div className="p-6 bg-gray-100 min-h-screen w-full lg:ml-[225px] relative">
            ...
            {showNotifications && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 sm:absolute sm:inset-auto sm:bg-transparent sm:block sm:right-0 sm:top-12">
