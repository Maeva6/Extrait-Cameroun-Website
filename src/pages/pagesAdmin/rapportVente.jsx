...
import {Bell, User, RefreshCcw, UserPlus, Download, HandCoins, ShoppingBag, ShoppingCart, ShoppingBasket} from 'lucide-react';
    ...
    return (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white p-6 rounded-lg shadow">
          <h2 className="text-lg font-semibold mb-4">Top 5 des produits les plus vendus</h2>
          <div className="h-80">
            <Bar
        ...
        <div className="bg-white p-6 rounded-lg shadow">
          <h2 className="text-lg font-semibold mb-4">Ventes par catégorie de produits</h2>
          <div className="h-80">
            <Pie
      ...
      {/* Tableau des données (optionnel) */}
      <div className="bg-white p-6 rounded-lg shadow">
        <h2 className="text-lg font-semibold mb-4">Détails des ventes</h2>
          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">CA (FCFA)</th>
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Part de marché</th>
              </tr>
            </thead>
