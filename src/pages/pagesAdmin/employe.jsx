...
import ConfirmDialog from '../../components/popUpSuppressionProduit'; // Assurez-vous d'avoir ce composant
    ...
    return (        
        <div className="p-6 space-y-8 bg-gray-100 min-h-screen w-full lg:ml-[225px]">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                {/* Carte Employés actifs */}
                <div className="bg-white p-4 rounded-lg shadow">
                    <div className="flex items-center">
                        <UserCheck className="text-[#D4AF37] mr-2" size={24}/>
                        <h1 className="text-gray-500 text-sm">Employés actifs</h1>
                    </div>
                ...
                <div className="bg-white p-4 rounded-lg shadow">
                    <div className="flex items-center"> 
                        <UserPlus className="text-[#D4AF37] mr-2" size={24}/>
                        <h1 className="text-gray-500 text-sm">Nouveaux</h1>
                    </div>
                    <p className="mt-2 text-2xl font-bold">1,000</p>
                </div>
                ...
                <div className="bg-white p-4 rounded-lg shadow">
                    <div className="flex items-center"> 
                        <Tag className="text-[#D4AF37] mr-2" size={24}/>
                        <h1 className="text-gray-500 text-sm">Vendeurs</h1>
                    </div>
                    <p className="mt-2 text-2xl font-bold">1,000</p>
                </div>
                ...
                <div className="bg-white p-4 rounded-lg shadow">
                    <div className="flex items-center"> 
                        <Briefcase className="text-[#D4AF37] mr-2" size={24}/>
                        <h1 className="text-gray-500 text-sm">Gestionnaires</h1>
                    </div>
                    <p className="mt-2 text-2xl font-bold">1,000</p>
                </div>
            </div>
