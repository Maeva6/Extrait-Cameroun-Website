...
const menuItems = [
  ...
  { id: 'ingredients', label: 'Ingredients', icon: <Cherry size={18} />, path: '/ingredients/admin' },
  { id: 'production-lab', label: 'Production', icon: <Factory size={18} />, path: '/productions/admin' },
  { id: 'fournisseurs', label: 'Fournisseurs', icon: <Truck size={18} />, path: '/fournisseurs/admin' },
  { id: 'formules', label: 'Formules', icon: <Sigma size={18} />, path: '/formules/admin' },
  ...
  { id: 'employes', label: 'Employés', icon: <Users size={18} />, path: '/employes/admin' },
