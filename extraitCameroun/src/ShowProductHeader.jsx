...
const links = [
  ...
  { name: 'Parfums de corps', to: '/famille/parfums-de-corps' },
  { name: 'Parfums d’ambiance', to: '/famille/parfums-dambiance' },
  { name: 'Cires et gels', to: '/famille/cires-et-gels' },
  { name: 'Accessoires', to: '/famille/accessoires' },
  { name: 'Extraits de ruche', to: '/famille/extraits-de-ruche' },
  { name: 'Body care', to: '/famille/body-care' },
  //  { name: "Extrait de parfum", path: "/extraits" },
  //   { name: "Eau de parfum", path: "/eau" },
  //   { name: "Brume parfumée", path: "/brumes" },
  //   { name: "Parfum de voiture", path: "/voiture" },
];

export default function ShowProductHeader() {
